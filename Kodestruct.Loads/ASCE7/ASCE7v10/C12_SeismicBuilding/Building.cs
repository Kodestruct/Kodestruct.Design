...
namespace Kodestruct.Loads.ASCE.ASCE7_10.SeismicLoads
{
    ...
    {
        public Building(ICalcLog CalcLog)
            : base(CalcLog)
        {

        }
        public Building(string LateralSystemId, ICalcLog CalcLog)
            : base(CalcLog)
        {
            this.LateralSystem = new BuildingLateralSystem(LateralSystemId, SeismicDesignCategory.None, CalcLog);
        }
