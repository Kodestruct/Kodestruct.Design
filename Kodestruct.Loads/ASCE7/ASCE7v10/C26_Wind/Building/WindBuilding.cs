...
namespace Kodestruct.Loads.ASCE.ASCE7_10.WindLoads.Building
{
    public partial class WindBuilding : WindStructure
    {
        ...
        public WindBuilding(double Width, double Length, double Height, double WindSpeed, WindExposureCategory windExposureType,
        ...
        public WindBuilding(ICalcLog CalcLog)
            : base(CalcLog)
        {
