...
using b = Kodestruct.Steel.AISC.AISC360v10.Connections.Bolted;
using b10 = Kodestruct.Steel.Tests.AISC.AISC360v10.Connections.Bolt;
...
namespace Kodestruct.Steel.Tests.AISC.AISC360v16.Connections.Bolt
{
    public class BoltGeneral: b10.BoltGeneral
    {

        public BoltGeneral(double Diameter, double F_nt, double F_nv): base(Diameter,  F_nt,  F_nv)
        {

        }

        protected override void GetBoltHoleDimensions(BoltHoleType HoleType, bool IsTensionOrShearCalculation = true)
        {
            ...
            using (StringReader reader = new StringReader(Resources.AISC360_16TableJ3_3NominalHoleDimensions))
            {
                string line;
            ...
            if (Diameter >= 1 + 1.0 / 8.0)
            {
                switch (HoleType)
                {
                    case BoltHoleType.STD:
                        d_hWidth = Diameter + 1 / 8.0;
                        d_hLength = Diameter + 1 / 8.0;
                        break;
                    ...
                    case BoltHoleType.OVS:
                        d_hWidth = Diameter + 5.0 / 16.0;
                        d_hLength = Diameter + 5.0 / 16.0;
                        break;
