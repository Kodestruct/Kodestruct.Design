...
namespace Kodestruct.Steel.AISC.Steel.Entities.Sections
{
    public class SteelHssSection: SteelSectionBase
    {
        private ISectionHollow section;

        public ISectionHollow Section
        {
            get { return section; }
        }
