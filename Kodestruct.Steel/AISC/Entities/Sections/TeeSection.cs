...
{
    public class SteelTeeSection:SteelSectionBase
    {

        public SteelTeeSection(ISectionTee Section, ISteelMaterial Material)
            :base(Material)
        {
            this.section = Section;
        }

        private ISectionTee section;

        public ISectionTee Section
        {
            get { return section; }
            set { section = value; }
        }
