...
namespace Kodestruct.Wood.NDS.NDS2015
{
    public abstract partial class SawnLumberMember : WoodMember, ISawnLumberMember
    {
        ...
        {
            double phi = 0.85; //Table 4.3.1
            double K_f = 2.54; //Table 4.3.1
        ...
        {
            double phi = 0.9; //Table 4.3.1
            double K_f = 2.4; //Table 4.3.1
        ...
        {
            double phi = 0.75; //Table 4.3.1
            double K_f = 2.88; //Table 4.3.1
        ...
        {
            double phi = 0.8; //Table 4.3.1
            double K_f = 2.7; //Table 4.3.1
